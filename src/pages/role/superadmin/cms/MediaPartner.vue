...
const saveMediaPartner = async () => {
    try {
        if (currentMedia.value) {
            await axios.post(`/media-partners/${currentMedia.value.id_media_partner}`, {
        ...
        console.error('Error updated Media Partner:', error);
        showToast('Error updated Media Partner.');
    }
};
                            ...
                            <table class="table custom-table rounded-4">
                                <thead class="thead-custom">
                                    <tr class="ps-4">
                                        ...
                                        <th class="fs-16 fw-medium w-200">Logo Media Partner</th>
                                        <th class="fs-16 fw-medium w-400">Nama Media Partner</th>
